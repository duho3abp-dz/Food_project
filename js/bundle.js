...
var calc = function calc() {
  ...
  var initCalc = function initCalc(parent, info, active) {
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(picture, alt, title, text, price, parentSelector) {
      ...
      for (var _len = arguments.length, newClass = new Array(_len > 6 ? _len - 6 : 0), _key = 6; _key < _len; _key++) {
        newClass[_key - 6] = arguments[_key];
      }
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/menu').then(function (data) {
    data.forEach(function (_ref) {
      var img = _ref.img,
          ...
          descr = _ref.descr,
          price = _ref.price;
      new MenuCard(img, altimg, title, descr, price, '[data-menu]', 'menu__item').render();
    });
  });
}
...
var forms = function forms(formsSelectors, modalSelector, formSelector, modalTimerId) {
  var forms = document.querySelectorAll(formsSelectors),
...
var modal = function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  var showModalByScrollEnd = function showModalByScrollEnd() {
...
var slider = function slider(_ref) {
  ...
  var transformSlider = function transformSlider(o, i, dots, dot) {
    slidesField.style.transform = "translateX(-".concat(o, "px)");
    i < 10 ? current.textContent = "0".concat(i) : current.textContent = i;
    dots.forEach(function (dot) {
      return dot.style.opacity = '';
    });
    dot.style.opacity = 1;
  };

  slides.length < 10 ? total.textContent = "0".concat(slides.length) : total.textContent = slides.length;
  slideIndex < 10 ? current.textContent = "0".concat(slideIndex) : current.textContent = slideIndex;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2020-10-19');
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"])('form', '.modal__content', 'form', modalTimerId);
